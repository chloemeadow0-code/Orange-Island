...
import com.newoether.agora.data.PluginToolParam
...
class PluginToolProvider(
    ...
    // ── Manifest → Agora schema ─────────────────────────────────

    /** Maps plugin-tool parameters onto Agora's [ToolParameters] (a small JSON-Schema subset). */

package com.orangeisland.app.ui.onboarding
        ...
        if (uri != null) {
            ...
            kotlinx.coroutines.CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    val aliasName = com.orangeisland.app.util.FileValidator.resolveFileName(context, uri)
...
private fun ApiKeyPage(
    ...
    localModels: List<com.orangeisland.app.data.LocalChatModelConfig> = emptyList()
) {
        ...
        if (models.isEmpty()) {
            ...
            Box(Modifier.fillMaxWidth().heightIn(max = 340.dp).drawBehind {
                ...
                Column(Modifier.verticalScroll(scrollState)) {
                    Spacer(Modifier.height(10.dp))
                    models.forEach { m ->
                        val name = modelAliases[m] ?: com.orangeisland.app.model.ModelId.parse(m).apiModelName

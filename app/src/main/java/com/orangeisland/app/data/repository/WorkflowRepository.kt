...
class WorkflowRepository(
     ...
     *  section. Rows with mode = "linear" are excluded ¡ª they belong to the v2 AI-authored section
    ...
    /** All enabled GRAPH-mode workflows ¡ª used by the scheduler on app start. Linear workflows
    ...
    /** Lightweight summary of EVERY workflow row regardless of mode ¡ª id/name/description/enabled/
    ...
    /** Flat summary used by the AI list tool ¡ª mode-agnostic so the model can branch on it. */

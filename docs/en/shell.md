...
橘子岛 can execute commands on remote machines through the [Conch](https://github.com/newo-ether/conch) protocol — an end-to-end encrypted secure shell designed for AI agents.

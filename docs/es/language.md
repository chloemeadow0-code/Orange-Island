...
|--------|--------|-------------|
| **Predeterminado del Sistema** | `system` | Sigue la configuración de idioma del sistema de tu dispositivo |
| **English** | `en` | Todo el texto de la interfaz en inglés |
| **简体中文** | `zh` | Todo el texto de la interfaz en chino simplificado |

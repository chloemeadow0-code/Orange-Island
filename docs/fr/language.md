...
|--------|------|-------------|
| **Langue du Système** | `system` | Suit le paramètre de langue du système de votre appareil |
| **Anglais** | `en` | Tout le texte de l'interface en anglais |
| **简体中文** | `zh` | Tout le texte de l'interface en chinois simplifié |

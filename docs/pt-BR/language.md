...
| Idioma | Código | Descrição |
|--------|--------|-----------|
| **Padrão do Sistema** | `system` | Segue a configuração de idioma do sistema do seu dispositivo |
| **English** | `en` | Todo o texto da interface em inglês |
| **简体中文** | `zh` | Todo o texto da interface em chinês simplificado |

## Como Alterar

1. Vá em **Configurações → Idioma**
